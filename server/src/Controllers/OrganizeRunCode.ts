...
import { OrganizeExecuteCode } from '../utils/OrganizeExecuteCode';

export const runOrganizeUserCode=async(req:Request,res:Response)=>{
...
try{
    const output=await OrganizeExecuteCode(language,userCode,input);
